"""PyTorch Lightning Module for ResNet38 (PANNs)."""

import torch

from src.architectures.plpann import PLPANN
from src.architectures.external.panns import ResNet38
from src.config.model_config import PLResNet38Config


class PLResNet38(PLPANN):
    """PyTorch Lightning Module for ResNet38 (PANNs)."""

    def __init__(self, config: PLResNet38Config) -> None:
